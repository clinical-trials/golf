...
import { ALL_PROGRAMS, EIGHT_WEEK, SIX_WEEK, WOMENS_SIX_WEEK, FAMILY_SIX_WEEK, FIRST_90_DAYS, PUTTING_FOUR_WEEK, PRACTICE_FOUR_WEEK, EQUIPMENT_BASICS, BUTLER_CLINIC } from '@/domain/program/curriculum'
...
describe('curriculum', () => {
  it('ships nine programs across the named segments', () => {
    expect(ALL_PROGRAMS).toHaveLength(9)
    ...
    expect(BUTLER_CLINIC.weeks).toHaveLength(4)
  })
