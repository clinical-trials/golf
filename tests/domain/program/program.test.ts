...
import { ALL_PROGRAMS, EIGHT_WEEK, SIX_WEEK, WOMENS_SIX_WEEK, FAMILY_SIX_WEEK, FIRST_90_DAYS } from '@/domain/program/curriculum'
...
describe('curriculum', () => {
  it('ships five programs across the named segments', () => {
    expect(ALL_PROGRAMS).toHaveLength(5)
